...
(function (i9graph, undefined) {
    ...
    i9graph.graph = function () {
        ...
        this._computeDegree = function (){
            var G = this;
            G.nodes.forEach(function(n){  n.degree=n.indegree=n.outdegree=0;  });
            G.edges.forEach(function (e) {
                G.nodes[ e.src ] . degree++;
                G.nodes[ e.src ] . outdegree++;
                G.nodes[ e.dst ] . degree++;
                G.nodes[ e.dst ] . indegree++;
            });
        }
